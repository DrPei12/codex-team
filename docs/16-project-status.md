...
**方向已更新，进入定义与设计衔接。** [项目定义v0.2](23-project-definition-v0.2.zh-CN.md)与[用户四项补充](24-direction-update-2026-09-14.md)成为后续方向依据，详见D-070。已有实现基线a911dbd及暂停记录fde6c2f保留。新方向要求跨领域委托、启发式澄清、约束平衡和Plugin交付；本轮仅同步文档，未恢复模型实验或启动安装发布。
